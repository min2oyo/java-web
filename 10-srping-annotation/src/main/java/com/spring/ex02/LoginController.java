package com.spring.ex02;	// 하위 패키지에 클래스가 위치해야 애너테이션이 적용됨
...
public class LoginController {
	...
	@RequestMapping(value = "/test/login.do", method = { RequestMethod.GET, RequestMethod.POST })	// GET, POST 모두 처리
	...
	public String login5(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		model.addAttribute("userName", "홍유진");
		return "result";
