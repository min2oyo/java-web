...
public class LoginServlet4 extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		System.out.println("LoginServlet4.init() 실행");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("LoginServlet4.doGet() 실행");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("LoginServlet4.doPost() 실행");
		doHandle(request, response);
	...
	protected void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("LoginServlet4.doHandle() 실행");
	...
	public void destroy() {
		...
		System.out.println("LoginServlet4.destroy() 실행");
