...
public class LoginServlet6 extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		System.out.println("LoginServlet6.init() 실행");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("LoginServlet6.doGet() 실행");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("LoginServlet6.doPost() 실행");
		doHandle(request, response);
	...
	protected void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("LoginServlet6.doHandle() 실행");
		...
		if (userId != null && userId.length() != 0) {
			...
			out.print("		<a href='/pro06/views/login/login6.html'>로그인 창으로 이동</a><br>");
	...
	public void destroy() {
		...
		System.out.println("LoginServlet6.destroy() 실행");
