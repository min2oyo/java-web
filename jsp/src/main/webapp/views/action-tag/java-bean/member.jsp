...
<%
	...
	if (request.getParameter("id") != null) memberDAO.addMember(new MemberVO(request.getParameter("id"), request.getParameter("pwd"), request.getParameter("name"), request.getParameter("email")));	//회원가입
